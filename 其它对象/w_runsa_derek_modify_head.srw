$PBExportHeader$w_runsa_derek_modify_head.srw
$PBExportComments$runsa_derek修改窗口
forward
global type w_runsa_derek_modify_head from w_single2_parent
end type
type st_2 from statictext within w_runsa_derek_modify_head
end type
type pb_lhbb from picturebutton within w_runsa_derek_modify_head
end type
type lb_1 from listbox within w_runsa_derek_modify_head
end type
type dw_head from datawindow within w_runsa_derek_modify_head
end type
type pb_import from picturebutton within w_runsa_derek_modify_head
end type
type pb_1 from picturebutton within w_runsa_derek_modify_head
end type
type ids_temp from datastore within w_runsa_derek_modify_head
end type
end forward
...
global w_runsa_derek_modify_head w_runsa_derek_modify_head
...
public function long wf_query_head (string as_outdate)
...
dw_head.move(li_marginx,dw_button.y + dw_button.height + li_marginy)
dw_head.width=li_width

dw_1.move(li_marginx,dw_head.y + dw_head.height + li_marginy) 
...
public function long wf_query_head (string as_outdate);string ls_nos,ls_chnos[],ls_channels[],ls_cusno
string ls_sql,ls_bz
string ls_ret,ls_errtext
boolean lb_wait
int li_chcount
long l_rowcount

ls_sql="select nos,cusno,bz from zg_channel where outdate='"+as_outdate+"' order by nos "
ls_errtext=u_dd.getquery(ids_temp,ls_sql)

if ls_errtext<>'' then goto e

ids_temp.settransobject(sqlca)
li_chcount=ids_temp.retrieve()

if li_chcount=0 then return 0

ls_chnos[]=ids_temp.object.nos.primary
ls_nos=u_dd.getstr(ls_chnos[],';',0)

ls_channels[]=ids_temp.object.cusno.primary
ls_cusno=u_dd.getstr(ls_channels[],';',0)

ls_bz=string(ids_temp.object.bz[1],'')

dw_head.settransobject(sqlca)
l_rowcount=dw_head.retrieve(ls_chnos[1])
...
//记录当前单据日期
is_outdate=string(dw_head.object.outdate[1],'')

if dw_head.setitem(1,'nos',ls_nos)=-1 then 
	ls_errtext="单号显示失败!~r~n"
end if
if dw_head.setitem(1,'cusno',ls_cusno)=-1 then 
	ls_errtext+="渠道显示失败!~r~n"
end if
if dw_head.setitem(1,'bz',ls_bz)=-1 then 
	ls_errtext+="备注显示失败!~r~n"
end if
...
on w_runsa_derek_modify_head.create
int iCurrent
call super::create
...
this.Control[iCurrent+5]=this.pb_import
this.Control[iCurrent+6]=this.pb_1
end on

on w_runsa_derek_modify_head.destroy
call super::destroy
destroy(this.st_2)
...
type p_11 from w_single2_parent`p_11 within w_runsa_derek_modify_head
end type

type pb_sendnote from w_single2_parent`pb_sendnote within w_runsa_derek_modify_head
integer x = 869
integer y = 1808
end type

type pb_daoru from w_single2_parent`pb_daoru within w_runsa_derek_modify_head
end type

type pb_gencon0 from w_single2_parent`pb_gencon0 within w_runsa_derek_modify_head
...
type cb_2 from w_single2_parent`cb_2 within w_runsa_derek_modify_head
boolean visible = false
integer x = 375
integer y = 20
end type

type st_button from w_single2_parent`st_button within w_runsa_derek_modify_head
end type

type dw_view from w_single2_parent`dw_view within w_runsa_derek_modify_head
end type

type dw_button2 from w_single2_parent`dw_button2 within w_runsa_derek_modify_head
end type

type dw_button from w_single2_parent`dw_button within w_runsa_derek_modify_head
integer x = 0
integer y = 0
end type

type pb_deleteall from w_single2_parent`pb_deleteall within w_runsa_derek_modify_head
end type

type pb_rowcopy from w_single2_parent`pb_rowcopy within w_runsa_derek_modify_head
end type

type dw_input6 from w_single2_parent`dw_input6 within w_runsa_derek_modify_head
end type

type pb_help from w_single2_parent`pb_help within w_runsa_derek_modify_head
end type

type em_zoom from w_single2_parent`em_zoom within w_runsa_derek_modify_head
end type

type pb_preview from w_single2_parent`pb_preview within w_runsa_derek_modify_head
end type

type dw_brow from w_single2_parent`dw_brow within w_runsa_derek_modify_head
integer x = 1627
integer y = 476
end type

type pb_browse from w_single2_parent`pb_browse within w_runsa_derek_modify_head
end type

type dw_words from w_single2_parent`dw_words within w_runsa_derek_modify_head
integer x = 0
integer y = 400
integer width = 2729
integer height = 1060
...
type pb_modify from w_single2_parent`pb_modify within w_runsa_derek_modify_head
integer x = 1349
integer y = 8
integer height = 104
integer textsize = -9
...
type dw_input5 from w_single2_parent`dw_input5 within w_runsa_derek_modify_head
integer x = 1390
integer y = 12
end type

type dw_input4 from w_single2_parent`dw_input4 within w_runsa_derek_modify_head
end type

type dw_input3 from w_single2_parent`dw_input3 within w_runsa_derek_modify_head
end type

type dw_input2 from w_single2_parent`dw_input2 within w_runsa_derek_modify_head
integer x = 55
integer y = 160
integer width = 1522
integer height = 416
...
type dw_input1 from w_single2_parent`dw_input1 within w_runsa_derek_modify_head
end type

type pb_ok from w_single2_parent`pb_ok within w_runsa_derek_modify_head
integer x = 325
integer y = 8
integer height = 104
integer textsize = -9
...
type sle_condition from w_single2_parent`sle_condition within w_runsa_derek_modify_head
boolean visible = false
integer x = 338
integer y = 32
integer width = 535
...
type pb_report from w_single2_parent`pb_report within w_runsa_derek_modify_head
boolean visible = false
integer x = 114
integer y = 20
end type

type st_info from w_single2_parent`st_info within w_runsa_derek_modify_head
end type

type st_1 from w_single2_parent`st_1 within w_runsa_derek_modify_head
end type

type pb_6 from w_single2_parent`pb_6 within w_runsa_derek_modify_head
end type

type pb_next from w_single2_parent`pb_next within w_runsa_derek_modify_head
end type

type pb_5 from w_single2_parent`pb_5 within w_runsa_derek_modify_head
end type

type pb_prior from w_single2_parent`pb_prior within w_runsa_derek_modify_head
end type

type pb_cancel from w_single2_parent`pb_cancel within w_runsa_derek_modify_head
integer x = 1093
integer y = 8
integer height = 104
integer textsize = -9
...
type pb_save from w_single2_parent`pb_save within w_runsa_derek_modify_head
integer x = 837
integer y = 8
integer height = 104
integer textsize = -9
...
ls_channels[]=u_dd.getsep(ls_cusno,';',0,1)
ls_chnos[]=u_dd.getsep(ls_nos,';',0,1)
...
//		ls_nos_temp=f_zg_nos(ls_channel,1,'tableflags=F;cusno=cusno;zg_channel',g_stanos)
		ls_nos_temp=u_derek.gnos('zg_channel',ls_tablename,ls_channel)
...
type pb_print from w_single2_parent`pb_print within w_runsa_derek_modify_head
integer x = 1861
integer y = 8
integer height = 104
integer textsize = -9
...
type pb_exit from w_single2_parent`pb_exit within w_runsa_derek_modify_head
integer x = 2117
integer y = 8
integer height = 104
integer textsize = -9
...
type pb_delete from w_single2_parent`pb_delete within w_runsa_derek_modify_head
integer x = 1605
integer y = 8
integer height = 104
integer textsize = -9
...
type pb_add from w_single2_parent`pb_add within w_runsa_derek_modify_head
integer x = 581
integer y = 8
integer height = 104
integer textsize = -9
...
//ls_channels[]=u_dd.getsep(ls_ret,'~r~n',0)
//li_chcount=u_dd.replaceex(ls_ret,'~r~n',';')
...
type dw_1 from w_single2_parent`dw_1 within w_runsa_derek_modify_head
integer x = 23
integer y = 416
integer width = 3607
integer height = 1620
...
type sle_1 from w_single2_parent`sle_1 within w_runsa_derek_modify_head
end type

type sle_3 from w_single2_parent`sle_3 within w_runsa_derek_modify_head
end type
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_runsa_derek_channel_initial_header"
boolean livescroll = true
end type

event type string ue_checkrow(long row);string ls_errtext,ls_title
string ls_notnull[]={'outdate','cusno'}
int i

//if getitemstatus(row,0,primary!)<>new! then
	for i=1 to upperbound(ls_notnull)
		if string(getitemstring(row,ls_notnull[i]),'')='' then 
			ls_title=describe(ls_notnull[i]+'_t.text')
			ls_errtext+=mid(ls_title,1,len(ls_title) - 1)+' 不能为空!'
			goto e
		end if
	next
//end if
...
//openwithparm(w_advance_query_derek,dw_1)
end event

type ids_temp from datastore within w_runsa_derek_modify_head descriptor "pb_nvo" = "true" 
end type
