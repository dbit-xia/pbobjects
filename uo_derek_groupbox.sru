$PBExportHeader$uo_derek_groupbox.sru
forward
global type uo_derek_groupbox from groupbox
end type
end forward
...
global uo_derek_groupbox uo_derek_groupbox
...
on uo_derek_groupbox.create
end on

on uo_derek_groupbox.destroy
end on
