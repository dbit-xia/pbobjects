$PBExportHeader$u_derek_taobao.sru
forward
global type u_derek_taobao from internetresult
end type
type md5_ctx from structure within u_derek_taobao
end type
type ds_params from datastore within u_derek_taobao
end type
end forward
...
global u_derek_taobao u_derek_taobao
...
string app_url="http://gw.api.tbsandbox.com/router/rest?" 
string app_key="393021b7"
string app_secret="adeaac8b252e4ed6a564cdcb1a064082"
string app_sessionkey='' //="8612ca7a98f84a3e9cdde3358e001454"
...
string ls_format='xml' //可选，指定响应格式。默认xml,目前支持格式为xml,json
...
if app_sessionkey<>'' then uf_param("session",app_sessionkey)
...
uf_params_reset()
uf_param("method",'taobao.trades.sold.get')
uf_param("fields",'title,nick,price,tid')
uf_params('start_date=2015-01-01 00:00:00&use_has_next=false&page_size=2')
...
on u_derek_taobao.create
call super::create
this.ds_params=create ds_params
TriggerEvent( this, "constructor" )
end on

on u_derek_taobao.destroy
TriggerEvent( this, "destructor" )
call super::destroy
destroy(this.ds_params)
end on

type ds_params from datastore within u_derek_taobao descriptor "pb_nvo" = "true" 
end type
